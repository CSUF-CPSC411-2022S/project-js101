...
func birdSearch(searchString: String, searchData: [birdData]) -> [birdData] {
    ...
    for bird in searchData {                                    // loop over the bird objects in search space
        mirroredObject = Mirror(reflecting: bird)               // create a mirror object of the bird
